...
- Location: subtree the repo under `.github/workflows/shared` so GitHub discovers the workflows.
...
# First add
git subtree add --prefix .github/workflows/shared shared-githubworkflows main --squash
# To pull updates later
git subtree pull --prefix .github/workflows/shared shared-githubworkflows main --squash
```
